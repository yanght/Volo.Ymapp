        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RetainCount = table.Column<int>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Deposit = table.Column<decimal>(nullable: false),
                    DateStart = table.Column<DateTime>(nullable: false),
                    DateOnline = table.Column<DateTime>(nullable: false),
                    DateOffline = table.Column<DateTime>(nullable: false),
                    CategoryId = table.Column<Guid>(nullable: false),
                    Recommend = table.Column<int>(nullable: false),
                    LineCategoryType = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastAsyncTime = table.Column<DateTime>(nullable: false)
                },
                constraints: table =>
                {
