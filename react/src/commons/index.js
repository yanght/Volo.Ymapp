...
const ACCESSTOKEN_KEY = 'access-token';
...
export function setAccessToken(token = {}) {
    const { access_token, expires_in, token_type, refresh_token, scope } = token;
    ...
    sessionStorage.setItem(ACCESSTOKEN_KEY, tokenStr)
...
export function toLogin() {
    ...
    localStorage.setItem(CURRENT_USER_KEY, null);
    localStorage.setItem(ACCESSTOKEN_KEY, null);
