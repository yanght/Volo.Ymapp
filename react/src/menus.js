...
export default function getMenus(userId) {
    ...
    return Promise.resolve([
        ...
        { key: 'Ymapp.Article', local: 'articles', text: '文章列表 ', icon: 'team', path: '/articles', order: 800 },
        ...
        { key: 'product', local: 'product', text: '商品中心', icon: 'ant-design', order: 700 },
        { key: 'productlist', parentKey: 'product', local: 'product', text: '商品列表', icon: 'ant-design', path: '/productlist', order: 700 },
    ].concat(antdMenus));
}
